...
kage dsa.eetac.upc.edu.minim2Irene;
...
import dsa.eetac.upc.edu.minim2Irene.API.API;
import dsa.eetac.upc.edu.minim2Irene.API.Repos;
import dsa.eetac.upc.edu.minim2Irene.API.User;
    ...
    public void init(){
        ...
        call.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                Picasso.get().load(user.getAvatar_url()).into(avatar); //imatge perfil git
